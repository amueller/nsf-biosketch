...
\emph{Interface} \sklearn{} provides a generic interface for machine learning, mainly consisting
...
\emph{Comprehensiveness} \sklearn{} implements a wide variety of models for classification,
...
These features lead to a wide-spread use of \sklearn{}, and the creation of a large
...
Oceanograpy~\autocite{sunagawa2015structure}, Sociology~\autocite{catalini2015incidence} and more.
...
Carnegie Mellon University, Columbia University, Duke Univserity, Harvard
University, Massechusetts Institute of Technology, New York University,
...
the \texttt{ROOT} scientific software framework.
...
\sklearn{} has become so propular in teaching and data science applications that
...
The simple interface of \sklearn{} has received numerous praise for its design
and user-friendlyness.  The main functionality of machine learning models can
...
Berkeley, Stanford University, Princeton University, Columbia Univserity,
University of Pensilvania, Georgetown University, Cornell University and
others.
...
While there are working implementations of meta-learning available (autoweka, \texttt{auto-sklearn}),
...
An often laborious and time-consuming part of analysis is data preprocessing and model tuning.
...
The close connection of the PI M\"uller to the \sklearn{} user community will
...
Adding to the \sklearn{} project, this proposal will leverage the existing infrastructure
...
Once these new features are included into the project, maintaining them will be possible
using the resources provided by the community. 
...
\begin{figure}
    ...
    \ganttbar{2 Provide devault ranges}{2017-05}{2018-4} \\
...
stackoverflow, the number of contributors, the number of people writing to the
...
unfortunately only one of the 38 \sklearn{} core developers is a women.
Similar issues can be found in related packages, with \texttt{NumPy} having no women among the 13 core
developers and \texttt{SciPy} having one women out of 22 core developers.
...
(\texttt{pandas}, \texttt{matplotlib}) to increase the impact of the workshop.

\subsection{Collaboration with \texttt{auto-sklearn}}
The \texttt{auto-sklearn} project~\autocite{feurer-nips2015} currently provides a research
...
\texttt{auto-sklearn} project to a easy-to-use and well-documented library, integrated
within the \sklearn{} ecosystem. To this end, we will collaborate
with the \texttt{auto-sklearn} team, building upon their insights and technologies.
Frank Hutter committed to providing the support of his group to integrate our
...
tasks, including classification and regression~\autocite{vanschoren2014openml}. At the time of this writing, there were nearly 20.000 datasets
hosted on OpenML, ranging from classical datasets like MNIST and small toy datasets like the iris and wine datasets,
to large scale datasets with millions or even tens of millions of samples, ranging from biological, medical and physical datasets
to commercial applications. This growing collection or research datasets provides the basis of our assessments, and
ensure relevance of our effort across research domains.
Joaquin Candela committed to improving and maintaining the Python interface for the OpenML platform,
...
outsiders to contributing to open source and enlarging the
