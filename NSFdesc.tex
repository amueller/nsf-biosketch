...
meta-learning~\autocite{feurer-nips2015}, these implementation are
...
\begin{labeling}{\textbf{Experimental Particle Physics}}
    \item[\textbf{Experimental Particle Physics}] Prof. Kyle Cranmer (NYU)
        committed to have his group be an early adopter of the proposed project
        for their work on searching new phenomena at the Large Hardron
        Collider.
    \item[\textbf{Astronomy}] Prof. David Hogg (NYU) committed to have his group be an
        early adopter of the proposed project for his work on analyizing
        telescope imaging data.
    \item[\textbf{Medical data analysis}] Prof. David Sontag (NYU) commited to
    ...
    \item[\textbf{Biostatistics}] Prof. Christopher Fonnesbeck (Vanderbilt
