...
a standard library for representing numeric data in Python, and integrating this generic
...
according to Google scholar\footnote{Nearly half of these citations have been
within the last year, demonstrating the accelerating growth of the ecosystem.}.
...
Python---that use \sklearn{} at the time of writing\footnote{this number trippled within the last year}.
...
INRIA, Telecom ParisTech, Paris-Saclay Center for Data Science and through Columbia University..
...
at their finger tips, as witnessed by the number of citations of the
paper describing \sklearn{}.
...
implementations, making it hard to triage bugs and provide a uniform interface. The
...
Furthermore, working within the GUI severely limits the available tools compared to
having the full flexibility of a programming language like Python or R.

In contrast, spark is an abstraction build on a cluster computing infrastructure
...
Within recent years, several implementations of automatic machine learning
have been published. Many available solutins are implementations of global optimization
algorithms, such as genetic programming and Bayesian optimization.
...
\begin{figure}
    ...
    \ganttbar{1 Analyze parameter ranges}{2016-11}{2017-04} \\
    ...
    \ganttbar{11 Analyze meta-learning}{2017-05}{2018-04} \\
...
could be used instead, but is  likely to underestimate the number of papers
using the \sklearn{} library in their research, as software is often not cited.
