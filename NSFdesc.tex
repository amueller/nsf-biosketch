...
state-of-the-art algorithms like Gradient Boosting, Random Forests and SAG
FIXME\@.  In addition to a large selection of algorithms, \sklearn{} also
contains a suite
...
Inria FIXME, Telecom ParisTech and through PI M\"uller as part of the
...
coordinated between PI M\"uller and Olivier Grisel at FIXME\@.
...
Courses using \sklearn{} have been taught at universities
...
In the tradition of FIXME and FIXME, we will identify strengths and weaknesses of existing
