...
machine learning with Python'' is currently in preparation by PI M\"ueller.
...
Inria FIXME, Telecom ParisTech and through PI M\"ueller as part of the
...
coordinated between PI M\"ueller and Olivier Grisel at FIXME\@.
...
Courses using \sklearn{} have been tought at universities
...
M\"ueller is well integrated into the development process of \sklearn{}.
...
The close connection of the PI M\"ueller to the \sklearn{} user community will
...
PI M\"ueller is a core developer and co-maintainer of \sklearn{} and deeply integrated
...
\begin{figure}
    ...
    \ganttbar{5 Integrate with auto-sklearn BO}{2017-11}{2018-10} \\
    ...
    \ganttbar{10 Sklearn $\leftrightarrow$ auto-sklearn sync}{2017-11}{2018-10} \\
...
Joaquin Candela commited to improving and maintaining the Python interface for the OpenML platform,
...
Dr.\ Andreas M\"ueller has not been a PI or co-PI on NSF grants.
